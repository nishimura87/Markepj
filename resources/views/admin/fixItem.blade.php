...
enctype="multipart/form-data">
  ...
  <div class="form-item">
    ...
    <div class="form-item-fix-img">
      ...
      <img class="img-sub2" src="{{ Storage::url($item['img_path1']) }}" >
      @endif
      @if(isset($item['img_path2']))
      <img class="img-sub2" src="{{ Storage::url($item['img_path2']) }}" >
      @endif
      @if(isset($item['img_path3']))
      <img class="img-sub2" src="{{ Storage::url($item['img_path3']) }}" >
      @endif
      @if(isset($item['img_path4']))
      <img class="img-sub2" src="{{ Storage::url($item['img_path4']) }}" >
      @endif
      @if(isset($item['img_path5']))
      <img class="img-sub2" src="{{ Storage::url($item['img_path5']) }}" >
      @endif
    </div>
